...
public class AnalysisHomeRecyclerAdapterBak extends RecyclerView.Adapter<AnalysisHomeRecyclerAdapterBak.ViewHolder> {
    Context context;
    ...
    public AnalysisHomeRecyclerAdapterBak(Context context, List<AnalysisItem> items, int num) {
        this.context = context;
        this.items = items;
        this.num = num;
    }
...
//                .into(holder.image);
        ...
        Response.Listener<String> responselistener1 = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    Log.e("pistolcaffe","recyclerview r: " + response);
