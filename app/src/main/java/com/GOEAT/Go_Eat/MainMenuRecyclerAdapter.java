...
public class MainMenuRecyclerAdapter extends RecyclerView.Adapter<MainMenuRecyclerAdapter.ViewHolder> { // 음식점 메뉴 아이템 넣어주는 클래스 방진혁
    Context context;
    ...
    public MainMenuRecyclerAdapter(Context context, List<Analysis_menu_Item> items, int num) {
        this.context = context;
        this.items = items;
        this.num = num;
    }
