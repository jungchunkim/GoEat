...
public class Fragment_home_after_3 extends Fragment {
    ...
    public Fragment_home_after_3(String menu,String main_menu,String companion) {
        this.menu= menu;
...
//서버에서 받은 Data 정보들 넣어주는 곳 2020-09-29 방진혁
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success.equals("true")){
                        ...
                        String[] url_3 = new String[10];
                        url_3[0] = jsonObject.getString("image0");
                        url_3[1] = jsonObject.getString("image1");
                        url_3[2] = jsonObject.getString("image2");
                        url_3[3] = jsonObject.getString("image3");
                        url_3[4] = jsonObject.getString("image4");
                        url_3[5] = jsonObject.getString("image5");
                        url_3[6] = jsonObject.getString("image6");
                        url_3[7] = jsonObject.getString("image7");
                        url_3[8] = jsonObject.getString("image8");
                        url_3[9] = jsonObject.getString("image9");
                        ...
                        for(int i=0;i<number;i++)
                        {
                            ...
                            if (jsonObject.getString(name).length()>1) {
                                Data_1[i] = new MainData(url_3[i], jsonObject.getString(name), jsonObject.getString(recommendmenu), jsonObject.getString(recommendprice), jsonObject.getString(address));
                            }else{
                                number = i;
                                break;
                            }
        ...
        get_restaurantlist get_restaurantlist = new get_restaurantlist(menu,main_menu,companion,responselistener3) ;
        RequestQueue queue = Volley.newRequestQueue(getActivity().getApplicationContext());
