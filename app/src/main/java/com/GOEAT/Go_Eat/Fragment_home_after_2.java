            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success.equals("true")){
                        ...
                        String[] url_2 = new String[10];
                        url_2[0] = jsonObject.getString("image0");
                        url_2[1] = jsonObject.getString("image1");
                        url_2[2] = jsonObject.getString("image2");
                        url_2[3] = jsonObject.getString("image3");
                        url_2[4] = jsonObject.getString("image4");
                        url_2[5] = jsonObject.getString("image5");
                        url_2[6] = jsonObject.getString("image6");
                        url_2[7] = jsonObject.getString("image7");
                        url_2[8] = jsonObject.getString("image8");
                        url_2[9] = jsonObject.getString("image9");
                        ...
                        for(int i=0;i<number;i++)
                        {
                            ...
                            if (jsonObject.getString(name).length()>1) {
                                Data_1[i] = new MainData(url_2[i], jsonObject.getString(name), jsonObject.getString(recommendmenu), jsonObject.getString(recommendprice), jsonObject.getString(address));
                            }else{
                                number = i;
                                break;
                            }
