...
public class GMailSender extends javax.mail.Authenticator implements Runnable{
    ...
    public GMailSender(String user, String password,String subject, String body, String recipients) {
        this.user = user;
