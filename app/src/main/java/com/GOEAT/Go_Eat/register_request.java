...
public class register_request extends StringRequest { // 회원 가입시 유저 정보 전송 부분
    ...
    public register_request(String username, String useremail, String userPassword, String usergender,String userbirth, String userage, String userphonenum ,Response.Listener<String> listener){
